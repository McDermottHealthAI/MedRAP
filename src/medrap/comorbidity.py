...
_ICD10_PREFIXES: dict[str, list[str]] = {
    ...
    "Moderate or severe liver disease": [
        "I85", "I864", "K704", "K711", "K721", "K729", "K765", "K766", "K767",
    ],
    ...
    *,
    ...
    return pl.DataFrame(
        ...
        schema={
            ...
            **{cat: pl.Boolean for cat in CHARLSON_CATEGORIES},
